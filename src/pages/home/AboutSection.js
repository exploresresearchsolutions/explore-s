        ...
        <div className="row align-items-start">
          ...
          <div className="col-lg-6">
            <div className="about__content" style={{ paddingTop: '0px' }}>
              ...
              >
                Welcome to <br /> <em>Explore S Research Solutions</em>
              </h2>
              <p
                className="about__paragraph wow animate__fadeInUp"
                data-wow-duration="0.5s"
              >
                Welcome to Explore S Research Solutions, your trusted partner in
                academic excellence. We are dedicated to providing top-tier
                research writing assistance to help you achieve your academic
                goals.
              </p>
              <p
              ...
              <p className="wow animate__fadeInUp" data-wow-duration="0.6s">
                Our team of seasoned experts brings years of experience across a
                broad spectrum of disciplines, ensuring that you receive
                personalized, high-quality support tailored to your unique
                needs. <br />
              ...
              <ul className="wow animate__fadeInUp" data-wow-duration="0.9s">
                ...
                <li className="last-li">
                  <em>Get Support</em>
                  <Link to="mailto:support@exploresresearchsolutions.in">
